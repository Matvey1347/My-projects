...
let postLike = document.querySelectorAll('.post__like');
let postDislike = document.querySelectorAll('.post__dislike');
let postNum = document.querySelectorAll('.post__num')
let nums = []
for (let index = 0; index < postNum.length; index++) {
	const element = postNum[index];
	nums.push(element.innerHTML) 
}

for (let index = 0; index < postLike.length; index++) {
	const element = postLike[index];
	element.addEventListener('click', function(){
		if(element.classList.contains('plus')){
postNum[index].innerHTML = +nums[index]
		element.classList.remove('plus')
		}else{
			postNum[index].innerHTML = +nums[index] + 1
		element.classList.add('plus')
		postDislike[index].classList.remove('minus')
		}
		
	})
}
for (let index = 0; index < postDislike.length; index++) {
	const element = postDislike[index];
	element.addEventListener('click', function(){
...
postNum[index].innerHTML = +nums[index]
		...
		postLike[index].classList.remove('plus')
		}
